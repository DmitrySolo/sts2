    ...
    <div class="group group--el">
        <?foreach($arResult["PERSON_TYPE"] as $v):?>
            <div class="col col-6-tl">
                <div class="radio" data-qcontent="element__buttons__radio">
                    <input class="radio__input" value="<?=$v["NAME"]?>" type="radio" id="PERSON_TYPE_<?=$v["ID"]?>" name="PERSON_TYPE"<?if ($v["CHECKED"]=="Y") echo " checked=\"checked\"";?> onClick="submitForm()"/>
