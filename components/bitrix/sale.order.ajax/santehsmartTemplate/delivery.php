                ...
                <div class="col col-4-tl">
                    <div class="radio<? if ($arDelivery["CHECKED"] == "Y") echo " radio--selected"; ?>"
                        ...
                        <label class="radio__label"
                               for="ID_DELIVERY_ID_<?= $arDelivery["ID"] ?>"><?= htmlspecialcharsbx($arDelivery["NAME"]) ?><br>
                            <?
                            ...
                            if (strlen($arDelivery["DESCRIPTION"])>0)
                                ...
                                ?>
                            <?=GetMessage("SALE_DELIV_PRICE");?>: <b><?=$arDelivery["PRICE_FORMATED"]?></b></label>
                    </div>
                </div>
                <?
            }
                    ...
                    if ($delivery_id == 59):?>
                        <div class="col col-8-tl">
                            <div id='curier'><label>Адрес для доставки курьером:<br><textarea
                                            ...
                                            cols="60"></textarea></label><br>
                            </div>
                        </div>
                    <? endif; ?>
                    <? if ($delivery_id == 58 && $arDelivery["CHECKED"] == "Y") $APPLICATION->IncludeComponent(
