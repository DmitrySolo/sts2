window.orderUIObject = {
    ...
    initTabs: function () {
        ...
        $('.order__checkPoint')
            .each(function (index) {
                if(index < _this.orderUIIndex) $(this).addClass('order__checkPoint--gone').addClass('order__way--gone')
                    .find('.order__checkPointNum').html('');
            })
        ...
        $('.toOrder.icon-to-right').on('click',(function (ev) {
            _this = this;
            $('.order__checkPoint')
                .each(function (index) {
                    if(index <= _this.orderUIIndex) $(this).addClass('order__checkPoint--gone').addClass('order__way--gone')
                ...
                .removeClass('order__checkPoint--active').eq(++this.orderUIIndex).addClass('order__checkPoint--active');
            $('.order__form').removeClass('order__form--active').eq(this.orderUIIndex).addClass('order__form--active');
            if(this.orderUIIndex == 4){
    ...
    ajaxCallbackFunction: function () {},
    ajaxCallback: function () {
        _this = window.orderUIObject;
        _this.ajaxCallbackFunction();
    ...
    {
        _this = window.orderUIObject;
        _this.ajaxCallbackFunction = ajaxCallback;
