...
<div class="bx_ordercart">
    <h4 style="display: none"><?=GetMessage("SALE_PRODUCTS_SUMMARY");?></h4>
    <div class="bx_ordercart_order_table_container" style="display: none">
        <table>
            <thead>
            <tr>
                <td class="margin"></td>
                ...
                <tr>
                    ...
                    foreach ($arResult["GRID"]["HEADERS"] as $id => $arColumn):
                        ...
                        if ($arColumn["id"] == "NAME"):
                            ...
                            ?>
                            <td class="item bxOrder__basket_info"
                                data-xml-id="<?=$arItem["PRODUCT_XML_ID"]?>"
                                ...
                                <td class="custom" style="<?=$columnStyle?>">
                                    ...
                                    foreach ($arItem[$arColumn["id"]] as $arValues):
                                        if ($arValues["type"] == "image"):
                                            ?>
                                            <div class="bx_ordercart_photo_container">
                                                <div class="bx_ordercart_photo" style="background-image:url('<?=$arValues["value"]?>') ;width: 50px;height:50px;background-size: contain"></div>
                                            </div>
                                            <?
                                        else: // not image
    ...
    <div class="bx_ordercart_order_pay group group--el">
        ...
        <div style="clear:both;"></div>
        <div class="bx_section col col-12-tl">
            <div class="bx_block w100 input__ctn">
                <h4><?=GetMessage("SOA_TEMPL_SUM_COMMENTS")?></h4>
                <textarea name="ORDER_DESCRIPTION" id="ORDER_DESCRIPTION"
                                                 style="width:100%;min-height:120px"><?=$arResult["USER_VALS"]["ORDER_DESCRIPTION"]?></textarea>
            </div>
