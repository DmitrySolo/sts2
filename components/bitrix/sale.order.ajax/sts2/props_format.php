		...
		if (!empty($arSource))
		{
            foreach ($arSource as $arProperties)
            {
                    ...
                    <div class="col col-4-tp">
                        <div class="input__ctn">
                            ...
                            <input class="textInput "
                                   ...
                                   type="checkbox"
                                   data-qcontent="element__INPUTS__textInput"
                    ...
                    <div class="col col-4-tp">
                        <div class="input__ctn">
                            ...
                            <textarea class="textInput "
                                   id="<?=$arProperties["FIELD_NAME"]?>"
                                   name="<?=$arProperties["FIELD_NAME"]?>"
                                   rows="<?=$rows?>" cols="<?=$arProperties["SIZE1"]?>"
                                   data-qcontent="element__INPUTS__textInput"><?=$arProperties["VALUE"]?></textarea>
                        </div>
                    </div>
                    <?
                }
                elseif ($arProperties["TYPE"] == "LOCATION")
                {
                    ...
                    <div class="col col-4-tp">
                        <div class="input__ctn">
                    <div class="bx_block r1x3 pt8 textInput__label">
                        <?=$arProperties["NAME"]?>
                        <?if ($arProperties["REQUIED_FORMATED"]=="Y"):?>
                            <span class="bx_sof_req">*</span>
                        <?endif;?>
