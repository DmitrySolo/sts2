...
?>
<div class="subscribeSts bx-subscribe"  id="sender-subscribe">
<?
...
?>
	...
	<form id="subscribeSts__form bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>">
		<?=bitrix_sessid_post()?>
		<input type="hidden" name="sender_subscription" value="add">

			<input class="subscribeSts__inpt bx-form-control" name="SENDER_SUBSCRIBE_EMAIL" value="<?=$arResult["EMAIL"]?>" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="<?=htmlspecialcharsbx(GetMessage('subscr_form_email_title'))?>">
		...
		<?endif;?>
			<button class="subscribeSts__btn sender-btn btn-subscribe" id="bx_subscribe_btn_<?=$buttonId?>">
...
?>
	...
	<form id="subscribeSts__form bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>">
		...
		<input type="hidden" name="sender_subscription" value="add">
			...
			<input class="subscribeSts__inpt bx-form-control" name="SENDER_SUBSCRIBE_EMAIL" value="" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="<?=htmlspecialcharsbx(GetMessage('subscr_form_email_title'))?>">
