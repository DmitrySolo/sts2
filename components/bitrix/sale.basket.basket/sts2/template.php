...
<!--        </div>-->
        <main><!-- split modules/cartPage -->
            ...
            {
                if(isPartnerClient()){
                    $arResult["ERROR_MESSAGE"] = str_replace("корзина","заявка пока",$arResult["ERROR_MESSAGE"]);
                    ShowError($arResult["ERROR_MESSAGE"]);
                    echo "<br><a href='/personal/cart/import' style='font-size: 18px;margin-left: 3px;color:#007FC3;'>Загрузить заявку из файла</a>";
                } else
                    ShowError($arResult["ERROR_MESSAGE"]);
            }
            ?>
