...
<div class="geoTarget__city">
    <span class="icon-placeholder"></span>
        <a class="geoTarget__link js_modal_trigger <?=$arResult['SETTINGS']['TF_LOCATION_HEADLINK_CLASS']?>" href="#tfLocationPopup" onclick="tfLocationPopupOpen('<?=$arResult['COMPONENT_PATH']?>', '<?=$arResult['SETTINGS']['TF_LOCATION_CALLBACK']?>'); return false;">
